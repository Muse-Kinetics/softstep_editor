...
/********************************************************************************
** Form generated from reading UI file 'navBoxForm.ui'
**
...
#ifndef UI_NAVBOXFORM_H
#define UI_NAVBOXFORM_H
...
#if QT_CONFIG(tooltip)
        keyName->setToolTip(QCoreApplication::translate("navBoxForm", "<b>Key Name</b><p>Set the name of this key.", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
