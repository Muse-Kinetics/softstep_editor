...
/********************************************************************************
** Form generated from reading UI file 'modlineForm.ui'
**
...
#ifndef UI_MODLINEFORM_H
#define UI_MODLINEFORM_H
...
"	background: none;\n"
"	image: url(:/re"
                        "sources/modline_combobox_menu_arrows.png);\n"
"	padding-right: 10px;\n"
"}\n"
"\n"
"/*-------QRadioButton-------*/\n"
...
"}"));
        ...
        label_13->setGeometry(QRect(32, 2, 21, 16));
...
"}"));
        ...
        label_42->setGeometry(QRect(494, 2, 30, 16));
...
"}"));
        ...
        deviceViewLabels->setCurrentIndex(1);
