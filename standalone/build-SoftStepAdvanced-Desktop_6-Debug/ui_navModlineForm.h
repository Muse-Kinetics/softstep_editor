...
/********************************************************************************
** Form generated from reading UI file 'navModlineForm.ui'
**
...
#ifndef UI_NAVMODLINEFORM_H
#define UI_NAVMODLINEFORM_H
...
"	background: none;\n"
"	image: url(:/resou"
                        "rces/modline_combobox_menu_arrows.png);\n"
"	padding-right: 10px;\n"
"}\n"
"\n"
"/*-------QRadioButton-------*/\n"
...
"}"));
        ...
        initvalue->setStyleSheet(QString::fromUtf8(""));
...
"}"));
        ...
        deviceViews->setCurrentIndex(10);
        deviceViewLabels->setCurrentIndex(0);
