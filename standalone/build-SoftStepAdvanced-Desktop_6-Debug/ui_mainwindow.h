...
"}"));
        ...
        connectedLabel->setGeometry(QRect(558, 81, 133, 22));
        QFont font;
...
"}"));
        ...
        frame_presets->setGeometry(QRect(10, 5, 235, 109));
...
"}"));
        ...
        frame_innerpresets->setGeometry(QRect(1, -2, 237, 108));
...
""));
        ...
        save->setGeometry(QRect(15, 42, 46, 20));
...
"}"));
        ...
        presetmenu->setGeometry(QRect(15, 10, 209, 26));
...
""));
        ...
        presetlabel->setGeometry(QRect(-4, 9, 14, 93));
...
"}"));
        ...
        update->setGeometry(QRect(16, 65, 209, 33));
...
"}s"));
        ...
        label->setGeometry(QRect(492, 7, 184, 65));
...
"}"));
        ...
        frame_displayname->setGeometry(QRect(579, 130, 101, 64));
...
"}"));
        ...
        displayName->setGeometry(QRect(9, 22, 83, 33));
...
"}"));
        ...
        presetlabel_3->setGeometry(QRect(14, 8, 73, 10));
...
"}"));
        ...
        label_2->setGeometry(QRect(10, 115, 670, 10));
...
"}"));
        ...
        frame_editormode->setGeometry(QRect(245, 5, 228, 109));
...
"}"));
        ...
        mode->setGeometry(QRect(7, 7, 215, 53));
...
""));
        ...
        opensetlist->setGeometry(QRect(7, 65, 104, 33));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(opensetlist->sizePolicy().hasHeightForWidth());
        opensetlist->setSizePolicy(sizePolicy);
...
"}"));
        ...
        opensettings->setGeometry(QRect(117, 65, 104, 33));
        sizePolicy.setHeightForWidth(opensettings->sizePolicy().hasHeightForWidth());
        opensettings->setSizePolicy(sizePolicy);
...
"}"));
        ...
        label_3->setGeometry(QRect(470, 140, 16, 16));
...
#if QT_CONFIG(tooltip)
        displayName->setToolTip(QCoreApplication::translate("MainWindow", "Sets the current preset's display name. <p> Anything entered here appears on<br> the SoftStep's alphanumeric display<br> when the preset is selected. <p>Limited to a maximum of four <br>characters.", nullptr));
#endif // QT_CONFIG(tooltip)
        displayName->setText(QCoreApplication::translate("MainWindow", "NEXU", nullptr));
        presetlabel_3->setText(QString());
        label_2->setText(QString());
#if QT_CONFIG(tooltip)
        mode->setToolTip(QCoreApplication::translate("MainWindow", "Switch between Hosted and Standalone mode.", nullptr));
#endif // QT_CONFIG(tooltip)
