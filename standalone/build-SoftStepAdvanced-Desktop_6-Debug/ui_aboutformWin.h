...
"}"));
        ...
        label_3->setStyleSheet(QString::fromUtf8("font: bold 10pt \"Corbel\";\n"
""));
        label_3->setAlignment(Qt::AlignCenter);
        expected = new QLabel(warningSubFrame);
        expected->setObjectName(QString::fromUtf8("expected"));
        expected->setGeometry(QRect(120, 40, 100, 16));
        ...
        found->setGeometry(QRect(120, 60, 100, 16));
        ...
        editor_version->setGeometry(QRect(120, 80, 100, 16));
