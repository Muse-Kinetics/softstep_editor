...
#include <memory>
#include "../advanced/hosted/delay.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Delay_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Delay_t qt_meta_stringdata_Delay = {
    {
QT_MOC_LITERAL(0, 5), // "Delay"
QT_MOC_LITERAL(6, 19), // "signalDelayedOutput"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 16), // "slotInputToDealy"
QT_MOC_LITERAL(44, 1), // "i"
QT_MOC_LITERAL(46, 14) // "slotSendOutput"

    },
    "Delay\0signalDelayedOutput\0\0slotInputToDealy\0"
    "i\0slotSendOutput"
};
...
void Delay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalDelayedOutput((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotInputToDealy((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotSendOutput(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Delay::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Delay::signalDelayedOutput)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Delay::staticMetaObject = { {
    ...
    qt_meta_stringdata_Delay.offsetsAndSize,
    qt_meta_data_Delay,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Delay_t
...
// SIGNAL 0
void Delay::signalDelayedOutput(int _t1)
{
