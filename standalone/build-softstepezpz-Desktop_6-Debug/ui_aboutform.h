...
""));
        ...
        warningFrame->setGeometry(QRect(0, 0, 241, 155));
...
""));
        ...
        ok->setGeometry(QRect(90, 110, 40, 20));
...
""));
        ...
        label_4->setGeometry(QRect(30, 80, 81, 20));
    ...
    void retranslateUi(QWidget *AboutForm)
    {
        ...
        label_3->setText(QCoreApplication::translate("AboutForm", "About SoftStep Basic Editor", nullptr));
