...
/********************************************************************************
** Form generated from reading UI file 'keyform.ui'
**
...
""));
        ...
        sourceNote->setGeometry(QRect(15, 12, 65, 16));
...
" }"));
        ...
        sourcePressure->setGeometry(QRect(15, 27, 52, 16));
...
" }"));
        ...
        sourceToggle->setGeometry(QRect(15, 42, 46, 16));
...
" }"));
        ...
        sourceXY->setGeometry(QRect(15, 57, 33, 16));
...
" }"));
        ...
        sourceYInc->setGeometry(QRect(15, 72, 39, 16));
...
" }"));
        ...
        sourceProgram->setGeometry(QRect(15, 87, 53, 16));
...
" }"));
        ...
        instanceLabel->setGeometry(QRect(100, 14, 51, 30));
        instanceLabel->setStyleSheet(QString::fromUtf8("font: 36pt \"Futura\";"));
...
"}"));
        ...
        sourcesParams->setGeometry(QRect(10, 105, 136, 41));
        sourcesParams->setContextMenuPolicy(Qt::NoContextMenu);
...
"}"));
        ...
        noteNum->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        noteVelocity->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        noteToggle->setGeometry(QRect(111, 20, 20, 24));
        noteToggle->setFocusPolicy(Qt::WheelFocus);
        noteToggle->setContextMenuPolicy(Qt::NoContextMenu);
        noteToggle->setStyleSheet(QString::fromUtf8("/* ---------- QCheckBox ------------*/\n"
"QCheckBox\n"
"{\n"
"color: rgba(255,255,255,250);\n"
"	font: 10pt \"Futura\";\n"
...
" }"));
        ...
        pressureSmoothLabel->setGeometry(QRect(91, 0, 40, 20));
        ...
        pressureCC->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        pressureSmooth->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        toggleCC->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        toggleLo->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        toggleHi->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        xyXCC->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        xyYCC->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        xyLatch->setGeometry(QRect(111, 20, 20, 24));
        xyLatch->setFocusPolicy(Qt::WheelFocus);
        xyLatch->setContextMenuPolicy(Qt::NoContextMenu);
        xyLatch->setStyleSheet(QString::fromUtf8("/* ---------- QCheckBox ------------*/\n"
"QCheckBox\n"
"{\n"
"color: rgba(255,255,255,250);\n"
"	font: 10pt \"Futura\";\n"
...
" }"));
        ...
        xyLatchLabel->setGeometry(QRect(101, 0, 40, 20));
        ...
        yIncCC->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        yIncSpeed->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        yIncSpeedLabel->setGeometry(QRect(85, 0, 51, 20));
        ...
        programNum->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        programNum->setMinimum(-1);
        programNum->setMaximum(127);
        programNum->setValue(-1);
        ...
        programBank->setContextMenuPolicy(Qt::NoContextMenu);
        ...
        programBankLabel->setGeometry(QRect(90, 0, 40, 20));
    ...
    void retranslateUi(QWidget *keyForm)
    {
        ...
        programNum->setSpecialValueText(QCoreApplication::translate("keyForm", "off", nullptr));
