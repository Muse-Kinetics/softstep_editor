...
##########################################
Softstep_Firmware_v1.0.1.syx
##########################################
Firmware version 1.0.1 uses the new "SoftStep Control Surface" and "SoftStep Expander" port names, and is required in order to use editor version 2.1.0 or later. 
