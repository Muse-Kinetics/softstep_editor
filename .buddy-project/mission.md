...
- The firmware path uses a packetized SysEx transport in `KMI_MDM` (hardware-validated).
- On Windows, both WMS and WinMM are compiled in; the active backend is selected at runtime. `KMI_MIDI_BACKEND=winmm` forces WinMM for testing.
